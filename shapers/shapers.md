...
-  **Light**: create (silent) illusions and make shadows.

-  **Water**: in its liquid form. Very experienced shapers can also shape ice.
   Water-shaping an animal is a very serious crime.
...
the player has to get a higher score than their opponent.
...
and made new bots whenever they can find the right materials.
...
Bots have Size, Fitness, Coordination, and IQ scores just like animal characters.
...
and her mother has taught her a bit of singing and stage magic.
...
| IQ        | Average | Knots        | High      |
| Sight     | Average | Stage Magic  | Low       |
| Hearing   | Average | Singing      | High      |
| Smell     | High    | Quarterstaff | High      |
